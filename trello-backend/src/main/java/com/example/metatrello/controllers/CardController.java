...
import com.example.metatrello.service.CardService;
...
public class CardController {
    ...
    public ResponseEntity<CardDTO> copyCard(@PathVariable String boardId, @RequestBody String cardId) {
        CardDTO copiedCard = cardService.copyCard(cardId, boardId);
     ...
     * @return A ResponseEntity containing the updated CardDTO.
     */
    @PutMapping("/{cardId}/add-member")
    public ResponseEntity<CardDTO> addCardMember(@PathVariable String cardId, @RequestBody String userId) {
        CardDTO updatedCard = cardService.addCardMember(cardId, userId);
        return ResponseEntity.ok(updatedCard);
    }
     ...
     *
     * @param cardId The ID of the card.
     * @param request A map containing 'userId'.
     * @return A ResponseEntity containing the updated CardDTO.
     */
    @PutMapping("/{cardId}/remove-member")
    public ResponseEntity<CardDTO> removeCardMember(
        ...
        CardDTO updatedCard = cardService.removeCardMember(cardId, userId);
        return ResponseEntity.ok(updatedCard);
    }
    ...
    public ResponseEntity<CardDTO> updateCardLinks(@PathVariable String cardId, @RequestBody List<String> links) {
        CardDTO updatedCard = cardService.updateCardLinks(cardId, links);
        return ResponseEntity.ok(updatedCard);
    }
